...
/* Define to 1 if `ifr_newname' is member of `struct ifreq'. */
...
#define PACKAGE_STRING "libvirt 1.2.2"
...
/* whether Lightos driver is enabled */
#define WITH_LIGHTOS 1
